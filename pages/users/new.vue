  ...
  b-row.mt-3
    ...
    b-col
      b-form-group#fieldset-city(description='Cidade.' label='Cidade' label-for='input-city')
        b-form-input#input-city(v-model='form.default' trim)
